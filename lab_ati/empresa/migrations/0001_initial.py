    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('cliente_empresa', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.CASCADE, related_name='clientes_empresa', to='empresa.empresa', verbose_name='Clientes tipo empresa')),
            ],
            options={
                'abstract': False,
            },
